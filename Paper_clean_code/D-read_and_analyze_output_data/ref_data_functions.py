...
def References_Dynoutputs():
    ...
    #ERA5
    ERA5_ua_60N_10hPa_198001_198912=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_ERA5_reanaly_1_Amon_ua_198001-198912_60N_10hPa_fldmean.nc')['ua'])
    ERA5_ua_60S_10hPa_198001_198912=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_ERA5_reanaly_1_Amon_ua_198001-198912_60S_10hPa_fldmean.nc')['ua'])
    ERA5_tauu_NAO_198001_198912=np.mean(netCDF4.Dataset('REFERENCE_DATA/tauu_ERA5_198001-198912_unstruc_NAO.nc')['tauu'])
    ERA5_tauu_SOO_198001_198912=np.mean(netCDF4.Dataset('REFERENCE_DATA/tauu_ERA5_198001-198912_unstruc_SOO.nc')['tauu'])

    #MERRA2
    MERRA2_ua_1980_1989_60N_10hPa=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_MERRA2_reanaly_5.12.4_Amon_ua_198001-198912_60N_10hPa_fldmean.nc')['ua'])
    MERRA2_ua_1980_1989_60S_10hPa=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_MERRA2_reanaly_5.12.4_Amon_ua_198001-198912_60S_10hPa_fldmean.nc')['ua'])
    MERRA2_tauu_NAO=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_MERRA2_reanaly_5.12.4_Amon_tauu_198001-198912_unstruc_NAO.nc')['tauu'])
    MERRA2_tauu_SOO=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_MERRA2_reanaly_5.12.4_Amon_tauu_198001-198912_unstruc_SOO.nc')['tauu'])

    #ERA-Interim
    ERAInterim_ua_1980_1989_60N_10hPa=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_ERA-Interim_reanaly_1_Amon_ua_198001-198912_60N_10hPa.nc')['ua'])
    ERAInterim_ua_1980_1989_60S_10hPa=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_ERA-Interim_reanaly_1_Amon_ua_198001-198912_60S_10hPa.nc')['ua'])
    ERAInterim_tauu_NAO=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_ERA-Interim_reanaly_1_Amon_tauu_198001-198912_unstruc_NAO.nc')['tauu'])
    ERAInterim_tauu_SOO=np.mean(netCDF4.Dataset('REFERENCE_DATA/OBS6_ERA-Interim_reanaly_1_Amon_tauu_198001-198912_unstruc_SOO.nc')['tauu'])
...
def Ref_clt():
    ...
    #clt
    #mean
    datafile='REFERENCE_DATA/OBS_CLARA-AVHRR_sat_V002_01_Amon_clt_198201-199112_fldmean.nc'
    file = Dataset('./'+datafile, "r", format="NETCDF4")
    ref_Clt_CLARA_AVHRR=np.mean(file['clt'][:][0][0][0])#% # need this mean because cdo -timavg does not work, maybe because the dates are alternatively 1st of month, and 15th of the month  
    #print('ref_Clt_CLARA_AVHRR',ref_Clt_CLARA_AVHRR)
    #std
...
def Ref_prw():
    ...
    #prw
    #mean
    datafile='REFERENCE_DATA/OBS6_ERA5_reanaly_v1_Amon_prw_198001-198912_fldmean_timavg.nc'
    file = Dataset('./'+datafile, "r", format="NETCDF4")
    ref_Prw_ERA5=file['prw'][:][0][0][0] #%
    #print('ref_Prw_ERA5',ref_Prw_ERA5)
    #std
    datafile='REFERENCE_DATA/OBS6_ERA5_reanaly_v1_Amon_prw_198001-198912_fldmean_timstd.nc'
    file = Dataset('./'+datafile, "r", format="NETCDF4")
...
def prw_era5_per_years():
    ...
    for yr in years_prw_era5:
        datafile='REFERENCE_DATA/OBS6_ERA5_reanaly_v1_Amon_prw_'+str(yr)+'_fldmean_timavg.nc'
        file = Dataset('./'+datafile, "r", format="NETCDF4")
        cltt=file['prw'][:][0][0][0] #%
...
def era5_data():
    ...
    ERA5_NAO_tauu=np.mean(netCDF4.Dataset('REFERENCE_DATA/tauumean_ERA5_NAO.nc')['tauu'])
    ERA5_SOO_tauu=np.mean(netCDF4.Dataset('REFERENCE_DATA/tauumean_ERA5_SOO.nc')['tauu'])
    ERA5_60N_10hPa_ua=np.mean(netCDF4.Dataset('REFERENCE_DATA/ERA5_ua_60N_10hPa.nc')['ua'])
    ERA5_60N_1000hPa_ua=np.mean(netCDF4.Dataset('REFERENCE_DATA/ERA5_ua_60N_1000hPa.nc')['ua'])
    ERA5_60S_10hPa_ua=np.mean(netCDF4.Dataset('REFERENCE_DATA/ERA5_ua_60S_10hPa.nc')['ua'])
    ERA5_60S_1000hPa_ua=np.mean(netCDF4.Dataset('REFERENCE_DATA/ERA5_ua_60S_1000hPa.nc')['ua'])
